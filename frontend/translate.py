...
replacements = {
    ...
    "종료된 최적화 (시작:": "Finished (Started:",
    "최적화 진행 중 - ": "Running - ",
    "시간 후 종료 후 영구 적용": "h left until auto-apply",
    "최적화 취소 및 삭제": "Cancel & Delete Test",
    "진행 중인 테스트를 안전하게 취소하고 삭제하시겠습니까?": "Are you sure you want to safely cancel and delete this test?",
    "유튜브 영상의 썸네일을 안전하게 '기본(A)'으로 자동 복구하며 삭제된 테스트는 복구할 수 없습니다.": "The thumbnail will be safely restored to 'Original (A)'. Deleted tests cannot be recovered.",
    "네, 안전하게 삭제합니다": "Yes, safely delete",
    "취소": "Cancel",
    "삭제 진행 중..": "Deleting...",
    "유튜브 썸네일을 안전하게 기본으로 복구하고 테스트를 삭제 중입니다.": "Restoring the original thumbnail and deleting the test.",
    "잠시만 기다려주세요...": "Please wait...",
    "삭제 완료": "Deleted",
    "테스트를 안전하게 취소하고 기본 썸네일로 복구했습니다.": "Test safely canceled and original thumbnail restored.",
    "오류": "Error",
    "테스트 삭제 중 문제가 발생했습니다.": "An error occurred while deleting the test.",
    "네트워크 오류가 발생했습니다.": "A network error occurred.",
    "최적화 조기 종료": "End Test Early",
    "현재까지 가장 좋은 성과를 보인 썸네일로 영구 적용하고 최적화를 종료하시겠습니까?": "Apply the best performing thumbnail permanently and end the test now?",
    "지금 즉시 적용": "Apply Now",
    "최적화 종료 중..": "Ending Test...",
    "유튜브 썸네일을 최종 승자로 지정하고 있습니다.": "Setting the winning thumbnail on YouTube.",
    "성공": "Success",
    "테스트가 성공적으로 종료되었으며, 최고 효율의 썸네일이 유튜브에 반영되었습니다.": "Test ended successfully. The winning thumbnail has been applied to YouTube.",
    "테스트 종료 중 문제가 발생했습니다.": "An error occurred while ending the test.",
    "자동 교체 성공": "Swap Successful",
    "유튜브 썸네일을 다음 후보로 즉시 교체했습니다.": "Thumbnail swapped to the next candidate immediately.",
    "교체 실패": "Swap Failed",
    ...
    "최고 효율 썸네일로 영구 고정 (조기 종료)": "Lock Winning Thumbnail (End Early)",
    ...
    "정해진 교체 시간을 무시하고 다음 썸네일 후보로 즉시 강제 교체해보는 기능입니다.": "It forcefully swaps to the next thumbnail candidate, ignoring the scheduled interval.",
